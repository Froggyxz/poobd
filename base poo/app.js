...
banco_1.banco.initialize().then(async () => {
    const pacienteService = new PacienteService_1.PacienteService();
    const medicoService = new MedicoService_1.MedicoService();
    const exameService = new ExameService_1.ExameService();
    const consultaService = new ConsultaService_1.ConsultaService();
    ...
    let consulta1 = new Consulta_1.Consulta(1, paciente1, medico1, new Date("2025-09-20T10:00:00"), 200.0);
