...
export class ExameService {
    ...
    async cadastrar(nome: string, codigo: string, especialidade_requerida: string, valor: number): Promise<Exame> {
        const exame = new Exame(nome, codigo, especialidade_requerida, valor);
